...
Multiple arguments have been added to `deGate`, and `plotDens`, please check the man page for these functions. These arguments include:
...
* `slope.w`: 	window.width for tracking the slope, when there is only one peak.
